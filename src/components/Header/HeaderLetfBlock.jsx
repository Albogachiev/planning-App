...
import { deletedAllCardAction } from "../../redux/actions/CardsAction.js";
import { toggleCheckedSaveBoardAction } from "../../redux/actions/HeaderAction.js";
  ...
  return (
    <div className={styles.container__left}>
      ...
      <div className={styles.container__left_content}>
        <h2 className={styles.container__left_Name}>Albo</h2>
